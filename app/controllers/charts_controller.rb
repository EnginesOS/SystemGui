class ChartsController < ApplicationController
  ...
  def total_container_memory_usage
    send_data(SystemInfo.total_container_memory_usage_pie_chart, :filename => "memory_usage_chart.png", :type => 'image/png')
  end
  ...
  def total_applications_memory_usage
    send_data(SystemInfo.total_applications_memory_usage_pie_chart, :filename => "memory_usage_chart.png", :type => 'image/png')
  end
  ...
  def total_services_memory_usage
    send_data(SystemInfo.total_services_memory_usage_pie_chart, :filename => "memory_usage_chart.png", :type => 'image/png')
  end
