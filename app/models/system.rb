module System
  ...
  def self.build_status_from_api
    engines_api.build_status.deep_symbolize_keys
  end
  ...
  def self.status
    ...
    {system: @status_from_api}.merge(
      ...
      elsif @status_from_api[:is_building]
  ...
  def self.get_engines_states
    engines_api.get_engines_states
  end

  def self.get_services_states
