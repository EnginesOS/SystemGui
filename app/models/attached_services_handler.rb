...
[
  {:class_name => 'Volume', :title => 'Volume - User data', some_identifier: 'vol#1'},
  {:class_name => 'Volume', :title => 'Volume - Site config', some_identifier: 'vol#2'},
...
Software.attached_subservices "Volume" >>> attached_services_for 'mediawiki', 'Volume'
